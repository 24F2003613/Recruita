...
from models.admin_models import (
    fetch_admin_profile,
    fetch_admin_dashboard_totals,
    fetch_all_applications_for_admin,
    fetch_all_drives_for_admin,
    fetch_companies_pending_clearance,
    fetch_drives_waiting_clearance,
    search_companies_for_admin,
    search_students_for_admin,
    toggle_company_active_status,
    toggle_student_active_status,
    update_company_approval as save_company_approval_status,
    update_drive_approval,
)
...
def register_admin_routes(app):
    ...
    def admin_dashboard():
        return render_template(
            ...
            dashboard_totals=fetch_admin_dashboard_totals(),
            companies_pending_clearance=fetch_companies_pending_clearance(),
            drives_waiting_clearance=fetch_drives_waiting_clearance(),
        )
    ...
    def approve_company(company_id):
        ...
        try:
            update_company_approval(company_id, approval_decision)
    ...
    def approve_drive(drive_id):
        try:
            update_drive_approval(drive_id, "Approved")
        except Exception as db_error:
    ...
    def reject_drive(drive_id):
        try:
            update_drive_approval(drive_id, "Closed")
        except Exception as db_error:
    ...
    def admin_students():
        ...
        return render_template(
            ...
            students_waiting_for_review=search_students_for_admin(student_search_query),
        )
    ...
    def toggle_student_active(student_id):
        try:
            toggle_student_active_status(student_id)
        except Exception as db_error:
    ...
    def admin_companies():
        ...
        return render_template(
            ...
            registered_companies=search_companies_for_admin(company_search_query),
        )
    ...
    def toggle_company_active(company_id):
        try:
            status_action = toggle_company_active_status(company_id)
            if status_action == "reactivated_pending":
                flash("Company activated and moved to Pending for re-approval.", "warning")
            elif status_action == "blacklisted":
    ...
    def update_company_approval(company_id):
        ...
        try:
            save_company_approval_status(company_id, approval_decision)
        except Exception as db_error:
    ...
    def admin_drives():
        return render_template(
            ...
            all_placement_drives=fetch_all_drives_for_admin(),
        )
    ...
    def admin_applications():
        return render_template(
            ...
            all_student_applications=fetch_all_applications_for_admin(),
        )

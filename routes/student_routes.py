...
from models.student_models import (
      create_student_application_for_drive,
      fetch_active_drives_for_student,
      fetch_drive_eligible_for_application,
      fetch_existing_student_application_for_drive,
      fetch_student_application_history_records,
      fetch_student_profile,
      update_student_profile_details,
)
...
def register_student_routes(app):
      ...
      def student_dashboard():
            ...
            return render_template(
                  ...
                  active_drive_records=fetch_active_drives_for_student(student_id, str(date.today())),
            )
      ...
      def apply_drive(drive_id):
            ...
            eligible_drive_for_application = fetch_drive_eligible_for_application(drive_id, str(date.today()))
            if not eligible_drive_for_application:
                  return "This drive is not available for applications", 400


            has_existing_application = fetch_existing_student_application_for_drive(student_id, drive_id)
            ...
            try:
                  create_student_application_for_drive(student_id, drive_id, str(date.today()))
      ...
      def application_history():
            ...
            return render_template(
                  ...
                  student_application_records=fetch_student_application_history_records(student_id),
            )

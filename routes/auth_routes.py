...
from models.auth_models import (
      ...
      fetch_admin_login_account,
      fetch_company_login_account,
      fetch_student_login_account,
)
...
def register_auth_routes(app):
      ...
      def home():
            ...
            selected_auth_view = request.args.get("view", "login").strip().lower()
            if selected_auth_view not in {"login", "register"}:
                  selected_auth_view = "login"
            ...
            return render_template(
                  ...
                  selected_auth_view=selected_auth_view,
